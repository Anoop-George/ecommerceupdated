    ...
    <div>
      <Grid container direction="row" justify="center" alignItems="center">
        <Grid
          ...
          xs={12}
          sm={8}
          style={{ backgroundColor: "#e6f5ea", padding: 14 }}
        >
          <Typography variant="h6"> Cash on Delivary </Typography>
        ...
        <Grid item xs={12} sm={8} style={{ margin: 5, padding: 8,backgroundColor:'#e6f5ea' }}>
        <Typography variant="h6" style={{padding:5}} > Pay using your card  </Typography>
          <Typography variant="body2" style={{padding:5}}>
            {" "}
           Pay online for husstle free delivery {" "}
          </Typography>
          <Button
            size="small"
            color="primary"
